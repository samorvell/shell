...
#|      Auterado para buscar arquivo .Z                  |
#|-------------------------------------------------------|
clear
OPT=999
while test $OPT -ne 0
        ...
        echo "                          Arquivo esta no diretorio! "
                ...
                read RESP
                        ...
                        exit 1
                                ...
                                for file in $LJ  ;   do
                                cp /home2/makro/st_rcv/str_000$file/old/scrcom$DIA.Z /home2/makro/st_rcv/str_000$file/scrcom$DIA.Z
                                DIR=/home2/makro/st_rcv/str_000$file/scrcom$DIA.Z
                                gunzip  $DIR
				#if [ $? != 0  ] ; then
				#	uncompress $DIR$DIR
				#	else
