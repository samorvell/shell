#! /bin/bash
clear
read -p "Informe o numero das lojas separadas por espaço:" LOJA
read -p "Informe a quantidade de arquivos:" QTD
read -p "Informe a data para analise dos arquivos aaaammdd:" DATA
